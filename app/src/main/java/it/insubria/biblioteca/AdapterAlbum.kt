...
class AdapterAlbum(private val itemList : ArrayList<Album>) : RecyclerView.Adapter<AdapterAlbum.ViewHolder>(){
    ...
    class ViewHolder(itemView : View, listener: onItemClickListener) : RecyclerView.ViewHolder(itemView){
        ...
        fun bind(album: Album) {
            titolo.text = album.titolo
            artista.text = album.artista

            // Carica l'immagine del libro utilizzando Glide
            Glide.with(itemView.context)
                .load(album.copertina)
