...
class AdapterFilm(private val itemList : ArrayList<Film>) : RecyclerView.Adapter<AdapterFilm.ViewHolder>(){
    ...
    class ViewHolder(itemView : View, listener: onItemClickListener) : RecyclerView.ViewHolder(itemView){
        ...
        fun bind(film: Film) {
            titolo.text = film.titolo
            data.text = film.annoUscita.toString()
