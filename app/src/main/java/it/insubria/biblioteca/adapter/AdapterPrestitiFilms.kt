...
class AdapterPrestitiFilms(private val itemList: ArrayList<PrestitoFilm>) : RecyclerView.Adapter<AdapterPrestitiFilms.ViewHolder>(){
    ...
    class ViewHolder(itemView : View, listener: onItemClickListener) : RecyclerView.ViewHolder(itemView){
        ...
        fun bind(prestitoFilm: PrestitoFilm) {
            titolo.text = prestitoFilm.titolo
            pubblicazione.text = prestitoFilm.annoUscita.toString()

            // Carica l'immagine del libro utilizzando Glide
            Glide.with(itemView.context)
                .load(prestitoFilm.copertina)
