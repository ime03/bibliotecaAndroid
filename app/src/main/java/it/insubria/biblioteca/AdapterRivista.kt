...
class AdapterRivista(private val itemList : ArrayList<Rivista>) : RecyclerView.Adapter<AdapterRivista.ViewHolder>(){
    ...
    class ViewHolder(itemView : View, listener: onItemClickListener) : RecyclerView.ViewHolder(itemView){
        ...
        private val data : TextView = itemView.findViewById(R.id.data_item)
        ...
        fun bind(rivista: Rivista) {
            titolo.text = rivista.titolo
            data.text = rivista.dataPubblicazione

            // Carica l'immagine del libro utilizzando Glide
            Glide.with(itemView.context)


                .load(rivista.copertina)
